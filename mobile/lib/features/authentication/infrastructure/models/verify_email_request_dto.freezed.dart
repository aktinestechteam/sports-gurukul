...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerifyEmailRequestDto&&(identical(other.token, token) || other.token == token));
}
...
@override
String toString() {
  return 'VerifyEmailRequestDto(token: $token)';
}
...
class _VerifyEmailRequestDto implements VerifyEmailRequestDto {
  const _VerifyEmailRequestDto({required this.token});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VerifyEmailRequestDto&&(identical(other.token, token) || other.token == token));
}
