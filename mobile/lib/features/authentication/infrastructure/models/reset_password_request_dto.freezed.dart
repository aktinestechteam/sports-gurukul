...
mixin _$ResetPasswordRequestDto {
 ...
 String get token; String get newPassword; String get confirmNewPassword;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,token,newPassword,confirmNewPassword);

@override
String toString() {
  return 'ResetPasswordRequestDto(token: $token, newPassword: $newPassword, confirmNewPassword: $confirmNewPassword)';
}
...
/// Create a copy of ResetPasswordRequestDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? token = null,Object? newPassword = null,Object? confirmNewPassword = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String token,  String newPassword,  String confirmNewPassword)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ResetPasswordRequestDto() when $default != null:
return $default(_that.token,_that.newPassword,_that.confirmNewPassword);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String token,  String newPassword,  String confirmNewPassword)  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordRequestDto():
return $default(_that.token,_that.newPassword,_that.confirmNewPassword);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String token,  String newPassword,  String confirmNewPassword)?  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordRequestDto() when $default != null:
return $default(_that.token,_that.newPassword,_that.confirmNewPassword);case _:
  return null;
...
class _ResetPasswordRequestDto implements ResetPasswordRequestDto {
  const _ResetPasswordRequestDto({required this.token, required this.newPassword, required this.confirmNewPassword});
...
/// Create a copy of ResetPasswordRequestDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? token = null,Object? newPassword = null,Object? confirmNewPassword = null,}) {
