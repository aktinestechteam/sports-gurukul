...
public class RecordRecentSearchCommandHandlerTests
{
    ...
    private readonly Mock<ILogger<RecordRecentSearchCommandHandler>> _loggerMock = TestMocks.CreateLogger<RecordRecentSearchCommandHandler>();
    private readonly RecordRecentSearchCommandHandler _handler;

    public RecordRecentSearchCommandHandlerTests()
    {
        _handler = new RecordRecentSearchCommandHandler(
    ...
    public async Task Handle_ValidCommand_RecordsSearchAndReturnsSuccess()
    {
        ...
        var result = await _handler.Handle(new RecordRecentSearchCommand
        {
            UserId = userId,
    ...
    public async Task Handle_ValidCommand_SetsSearchedAtToUtcNow()
    {
        ...
        await _handler.Handle(new RecordRecentSearchCommand
        {
            UserId = Guid.NewGuid(),
            QueryText = "tennis",
            FiltersJson = "{}",
