...
public class DeleteSavedSearchCommandHandlerTests
{
    ...
    private readonly Mock<ILogger<DeleteSavedSearchCommandHandler>> _loggerMock = TestMocks.CreateLogger<DeleteSavedSearchCommandHandler>();
    private readonly DeleteSavedSearchCommandHandler _handler;

    public DeleteSavedSearchCommandHandlerTests()
    {
        _handler = new DeleteSavedSearchCommandHandler(
    ...
    public async Task Handle_SearchNotFound_ReturnsFailure()
    {
        ...
        var result = await _handler.Handle(new DeleteSavedSearchCommand
        {
            Id = Guid.NewGuid(),
            UserId = Guid.NewGuid()
