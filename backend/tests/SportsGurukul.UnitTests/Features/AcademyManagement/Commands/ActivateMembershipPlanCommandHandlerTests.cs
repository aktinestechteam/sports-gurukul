...
public class ActivateMembershipPlanCommandHandlerTests
{
    private readonly Mock<IAcademyMembershipRepository> _membershipRepositoryMock;
    private readonly Mock<IUnitOfWork> _unitOfWorkMock;
    private readonly Mock<ILogger<ActivateMembershipPlanCommandHandler>> _loggerMock;
    private readonly ActivateMembershipPlanCommandHandler _handler;

    public ActivateMembershipPlanCommandHandlerTests()
    {
        _membershipRepositoryMock = new Mock<IAcademyMembershipRepository>();
        _unitOfWorkMock = new Mock<IUnitOfWork>();
        _loggerMock = new Mock<ILogger<ActivateMembershipPlanCommandHandler>>();
        _handler = new ActivateMembershipPlanCommandHandler(
    ...
    public async Task Handle_ValidRequest_ActivatesPlan()
    {
        ...
        var command = new ActivateMembershipPlanCommand { MembershipId = membershipId };
