...
public class PineconeVectorStore : BaseVectorStore
{
    public override VectorStoreType StoreType => VectorStoreType.Pinecone;
    public override string StoreName => "Pinecone";
