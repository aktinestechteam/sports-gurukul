...
public class PgVectorVectorStore : BaseVectorStore
{
    public override VectorStoreType StoreType => VectorStoreType.PgVector;
    public override string StoreName => "PostgreSQL pgvector";
    ...
    public override Task<bool> IndexExistsAsync(string indexName, CancellationToken cancellationToken = default) => Task.FromResult(InMemoryIndices.ContainsKey(indexName));
