...
public class WeaviateVectorStore : BaseVectorStore
{
    public override VectorStoreType StoreType => VectorStoreType.Weaviate;
    public override string StoreName => "Weaviate";
